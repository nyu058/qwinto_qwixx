...
${OBJECTDIR}/QwintoPlayer.o: QwintoPlayer.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/QwintoPlayer.o QwintoPlayer.cpp

${OBJECTDIR}/QwintoRow.o: QwintoRow.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/QwintoRow.o QwintoRow.cpp

${OBJECTDIR}/QwintoScoreSheet.o: QwintoScoreSheet.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/QwintoScoreSheet.o QwintoScoreSheet.cpp

${OBJECTDIR}/QwixxPlayer.o: QwixxPlayer.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/QwixxPlayer.o QwixxPlayer.cpp

${OBJECTDIR}/QwixxRow.o: QwixxRow.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/QwixxRow.o QwixxRow.cpp

${OBJECTDIR}/QwixxScoreSheet.o: QwixxScoreSheet.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/QwixxScoreSheet.o QwixxScoreSheet.cpp

${OBJECTDIR}/RandomDice.o: RandomDice.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RandomDice.o RandomDice.cpp

${OBJECTDIR}/RollOfDice.o: RollOfDice.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RollOfDice.o RollOfDice.cpp

${OBJECTDIR}/ScoreSheet.o: ScoreSheet.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ScoreSheet.o ScoreSheet.cpp
